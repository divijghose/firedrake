...
What goes [here](https://github.com/firedrakeproject/firedrake/wiki/Updating-forked-dependencies#git-merge-vs-git-rebase). Thanks to Connor for these wkiki contributions!
