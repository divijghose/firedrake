...
1. Download VSCode from the [website](https://code.visualstudio.com/) and install it.
2. Install the "Remote-SSH" extension within VSCode.
3. Generate an ssh key in ``/home/local_username/.ssh/``, if you don't already have one.
4. Add this ssh key to your ARCHER2 account, if it hasn't already been.
5. Append the following to ``/home/local_username/.ssh/config``:
...
[Troubleshooting for Mac](https://vscode.readthedocs.io/en/latest/setup/mac/).