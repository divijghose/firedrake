...
# Debugging C Code - **Won't work as described on MacOS**
...
**NOTE**: This may now not be true, see [Debugging C kernels with lldb on MacOS](https://github.com/firedrakeproject/firedrake/wiki/Debugging-C-kernels-with-lldb-on-MacOS).
