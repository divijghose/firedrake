...
1. ~LC: Deprecate `.at()` ([minutes](https://github.com/firedrakeproject/firedrake/wiki/Firedrake-meeting-2025-08-13))~ ([PR](https://github.com/firedrakeproject/firedrake/pull/4547))
