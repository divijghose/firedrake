...
- DH: by _this_ week double-check Jupiter server is running (follow up)
...
Last weeks discussion is in included below (minuter delete as appropriate).
...
- moved to _this_ week, needs a Lawrence!
