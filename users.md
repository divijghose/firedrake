### University of Leeds
* Onno Bokhove (http://www1.maths.leeds.ac.uk/~obokhove/)
  Geophysical fluids: interaction of ships with waves.
  Hamiltonian/variational formulations

* Daniel Ruprecht ? (https://engineering.leeds.ac.uk/staff/741/dr_daniel_ruprecht)
  Parallel in time

### Kiel University
* Julian Andrej  (https://www.control.tf.uni-kiel.de/en/staff/staff/m-sc-julian-andrej)
  Optimal control, reduced order models

### Imperial College
* Colin Cotter, Jemma Shipton
  Atmospheric fluid dynamics, parallel in time (http://www.firedrakeproject.org/gusto)
...
* Justin Chang
  Subsurface flow, performance modelling
...
### University of Bath
* Eike Mueller
  Multigrid preconditioning for atmosphere, high order DG?
