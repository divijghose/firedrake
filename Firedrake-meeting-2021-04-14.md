...
## CW: Discussion of my [PR](https://github.com/firedrakeproject/firedrake/pull/1983)

This is now done apart from some minor docstring improvements. Would be good to merge ASAP.
